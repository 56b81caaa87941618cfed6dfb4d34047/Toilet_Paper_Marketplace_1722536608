...
Vue.component("purple_feature_grid_component_1722536609", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            <div id="feature-1-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-1-title-container"><h4 id="feature-1-title" class="flex-1 font-medium" :class="textSecondaryStyle">Unbeatable Supply Chain</h4></div>
            </div>
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our global network of suppliers ensures a steady stream of the softest, most absorbent toilet paper rolls. Never run out again!</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-2-title-container"><h4 id="feature-2-title" class="flex-1 font-medium" :class="textSecondaryStyle">Bulk Discounts Galore</h4></div>
            </div>
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">The more you buy, the more you save. Our bulk pricing tiers offer incredible discounts on toilet paper by the truckload.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container"><h4 id="feature-3-title" class="flex-1 font-medium" :class="textSecondaryStyle">Subscription Options</h4></div>
            </div>
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Sign up for our convenient toilet paper subscription service. Choose your preferred ply, get automatic deliveries, and never worry about running low.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 font-medium" :class="textSecondaryStyle">Eco-Friendly Choices</h4></div>
            </div>
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Go green with our premium recycled and bamboo toilet paper products. Luxury softness that's gentle on the planet.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container"><h4 id="feature-5-title" class="flex-1 font-medium" :class="textSecondaryStyle">Lightning Fast Delivery</h4></div>
            </div>
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Your toilet paper will arrive at your doorstep with amazing speed. Because when you gotta go, you gotta go with a fresh, clean roll.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container"><h4 id="feature-6-title" class="flex-1 font-medium" :class="textSecondaryStyle">Rewards Program</h4></div>
            </div>
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">Earn points with every purchase toward future discounts and free toilet paper. The more you spend, the more you're rewarded for your business!</p></div>
        </div>
    </div>`,
        data() {
            return {
