...
Vue.component("purple_header_component_1722536609", {
    template: `
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        <li><a id="Buy Toilet Paper-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" :class="[textStylePrimary, hoverTextStylePrimary]" href="Buy Toilet Paper.html">Buy Toilet Paper</a></li>
                        <li><a id="Sell Toilet Paper-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Sell Toilet Paper.html" :class="[textStylePrimary, hoverTextStylePrimary]">Sell Toilet Paper</a></li>
                        <li><a id="Toilet Paper Prices-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Toilet Paper Prices.html" :class="[textStylePrimary, hoverTextStylePrimary]">Toilet Paper Prices</a></li>
                        <li><a id="Toilet Paper News-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Toilet Paper News.html" :class="[textStylePrimary, hoverTextStylePrimary]">Toilet Paper News</a></li>
                        <li><a id="About UsTP.com-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="About UsTP.com.html" :class="[textStylePrimary, hoverTextStylePrimary]">About UsTP.com</a></li>
                    </ul>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" : @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5" :class="signUpButtonGradient">
                            <li><a id="mobile-Buy Toilet Paper-link" class="flex font-medium text-sm py-1.5" href="Buy Toilet Paper.html" :class="[textStylePrimary,hoverTextStylePrimary]">Buy Toilet Paper</a></li>
                            <li><a id="mobile-Sell Toilet Paper-link" class="flex font-medium text-sm py-1.5" href="Sell Toilet Paper.html" :class="[textStylePrimary,hoverTextStylePrimary]">Sell Toilet Paper</a></li>
                            <li><a id="mobile-Toilet Paper Prices-link" class="flex font-medium text-sm py-1.5" href="Toilet Paper Prices.html" :class="[textStylePrimary,hoverTextStylePrimary]">Toilet Paper Prices</a></li>
                            <li><a id="mobile-Toilet Paper News-link" class="flex font-medium text-sm py-1.5" href="Toilet Paper News.html" :class="[textStylePrimary,hoverTextStylePrimary]">Toilet Paper News</a></li>
                            <li><a id="mobile-About UsTP.com-link" class="flex font-medium text-sm py-1.5" href="About UsTP.com.html" :class="[textStylePrimary,hoverTextStylePrimary]">About UsTP.com</a></li>
                        </ul>
                    </nav>
